...
@pytest.mark.asyncio
async def test_summarize_pdf_local_large():
    """
    ...
    summary = await summarize_pdf_local(large_pdf_path, summarization_prompt)
...
@pytest.mark.skipif(not os.getenv("GEMINI_API_KEY"), reason="GEMINI_API_KEY is not set")
@pytest.mark.asyncio
async def test_summarize_pdf_local_small():
    """
    ...
    summary = await summarize_pdf_local(small_pdf_path, summarization_prompt)
